...
const KhaataLedger = ({ sales, stats }) => {
                        ...
                        {creditSales.map(sale => (
                            <tr key={sale._id} className="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button className="bg-emerald-600 text-white px-4 py-2 rounded-xl text-xs font-black hover:bg-emerald-700 transition-all active:scale-95">
                                        Settle Bill
                                    </button>
                                </td>
                            </tr>
