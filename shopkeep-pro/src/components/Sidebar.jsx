...
import { LayoutDashboard, Package, ShoppingCart, BookOpen, History, ShieldCheck, ShieldAlert, Users } from 'lucide-react';

const Sidebar = ({ activeTab, setActiveTab, isAdmin, setIsAdmin }) => {
    const tabs = [
